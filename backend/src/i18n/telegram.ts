...
export const resources = {
    'zh-CN': {
        'bot.wizard.confirmSource': '📡 来源：{source}',
        'bot.wizard.confirmComments': '💬 评论区：{value}',
        'bot.wizard.folder.defaultValue': '默认分类规则',
        'bot.wizard.storage.current': '当前存储',
        'bot.wizard.storage.currentAccount': '当前账户',
        'path.error.empty': '路径不能为空',
        'path.error.illegalChars': '路径包含非法字符',
        'path.error.dotSegments': '路径不能包含 . 或 ..',
        'path.error.invalid': '路径无效',
        'path.error.tooLong': '路径过长，请控制在 180 个字符内',
        ...
        'auth.success': '✅ 密码验证通过',
        'auth.startPrompt': '**TG Vault Bot**\n\n🔐 请使用下方键盘输入密码：',
        'auth.welcomeBack': '**TG Vault Bot**\n\n发送或转发文件即可上传。\n/help 查看帮助。',
        'auth.successBody': '✅ **密码验证通过**\n\n📤 发送或转发文件即可上传（最大 2 GB；账号下载器不受此限制）。\n📊 /storage 查看存储空间。',
        'auth.twoFactorPrompt': '🔐 密码验证通过\n\n请输入 **6 位 2FA 验证码** 完成登录：',
        'auth.twoFactorToast': '请输入 2FA 验证码',
        'auth.twoFactorWrong': '❌ 验证码错误，请重新输入 6 位数字：',
        'auth.twoFactorActivated': '✅ **2FA 已启用**',
        'auth.twoFactorLoginOk': '✅ **2FA 验证通过**',
        ...
        'keyboard.more': '☰ 更多',
        'keyboard.cancel': '取消',
        'bot.subscription.selectChannel': '共 {count} 个订阅，点击频道查看详情和管理操作。',
        'bot.subscription.backToList': '← 返回频道列表',
        'help.body': "**📖 命令帮助**\n\n直接发送或转发文件即可上传。\n\n/start — 开始使用 / 验证身份\n/help — 显示本帮助\n/language — 切换界面语言\n\n**📁 文件与保存**\n\n/list — 查看最近文件和文件 ID\n/find — 搜索文件并打开操作卡\n/delete — 按文件 ID 前缀删除文件\n/path_rules — 设置保存位置与目录规则\n/p — 设置下一次保存目录\n/ps — 设置当前会话保存目录\n/pc — 清除自定义保存目录\n/target — 设置下次或当前聊天的存储目标\n\n**📥 下载与任务**\n\n/tasks — 查看任务与进度\n/task_pause — 暂停当前聊天或指定任务\n/task_resume — 继续当前聊天或指定任务\n/task_cancel — 预览并取消任务\n/stop_tasks — 预览并停止当前聊天任务\n/tg_retry — 重试失败的下载\n\n**📡 频道与订阅**\n\n/tg_download — 按日期或标签下载频道文件\n/tg_sub — 设置频道自动同步\n/tg_subs — 查看频道订阅\n/tg_unsub — 取消指定频道订阅\n\n**⚙️ 存储与设置**\n\n/storage — 查看存储 / 确认删除本地文件\n/storage_switch — 切换系统默认存储（影响所有新任务）\n/download_workers — 设置单文件分片并发\n/file_concurrency — 设置同时下载的文件数\n/duplicate_mode — 设置重复文件处理方式\n/cleanup_settings — 设置未索引临时文件自动清理\n/notifications — 设置通知、时区与安静时段\n/status — 查看系统诊断状态\n\n**🔐 账号安全**\n\n/setup_2fa — 配置双重验证\n/logout — 退出并撤销当前用户的 Bot 认证",
        ...
        'channels.errors.fixedTargetProviderRequired': '请选择订阅固定存储的提供商',
        'channels.storageCooldown': '⏸️ Google Drive 今日上传额度已达上限\n\n任务已暂停，将在额度恢复后自动继续。无需手动继续。\n\n恢复时间：{retryAt}\n任务：{jobId}',
        ...
        'upload.failureRetryNote': '🔄 已自动重试一次。',
        ...
        'taskCenter.button.resume': '▶️ 继续任务',
        'taskCenter.button.undoPause': '▶️ 继续任务',
        ...
        'status.requestId': '请求 ID：{requestId}',
        'status.degraded': '（降级）',
        ...
        'status.reconciliation': '对账：待处理 {pending} · 需人工 {operatorRequired}',
        'status.advice': '建议：{action}',
        'status.defaultAdvice': '组件异常时，可用请求 ID 查询服务器日志。',
        'path.preview': '保存到：{folder}/文件名（不会追加频道名或文件类型目录）',
        'path.prompt.onceTitle': '📌 **设置下一次下载目录**',
        'path.prompt.sessionTitle': '📍 **设置本聊天下载目录**',
        ...
        'path.prompt.onceNote': '仅影响下一次进入下载流程的文件。',
        'path.prompt.sessionNote': '影响当前聊天后续下载，直到发送 `/pc` 或清除设置。',
        ...
        'path.recent.title': '🕘 **最近使用目录**',
        'path.recent.hint': '在“保存位置”中选择下一次或本聊天目录，然后发送目录名称。',
        'path.recent.empty': '🕘 暂无最近使用目录。',
        'path.toast.recentSent': '已发送最近目录',
        'path.toast.sendFolder': '请发送目录名称，或发送“取消”退出',
        'path.toast.updated': '已更新保存位置',
        'path.toast.cancelled': '已取消保存路径设置。',
        'bot.home.category.main': '常用命令',
        ...
        'bot.home.logoutHint': '发送 /logout 立即撤销当前 Telegram 用户的 Bot 认证。',
        'bot.home.twoFactorHint': '发送 /setup_2fa 配置双重验证。',
        ...
        'bot.legacy.floodWait': '⏳ Telegram FloodWait 冷却到：{until}',
        ...
        'bot.auth.notAllowed': '⛔ 当前 Telegram 用户不在允许列表中。请在 TELEGRAM_ALLOWED_USER_IDS 或网页端允许列表中添加用户 ID。',
        ...
        'bot.notification.securityLogin': '🔔 **登录提醒**\n\n👤 **账号**：管理员\n⏰ **时间**：{time}\n🌐 **地区**：{location}\n💻 **设备**：{device}\n🔌 **IP 地址**：{ip}\n\n💡 如非本人操作，请立即检查服务器安全设置。',
        ...
        'commands.auto003': '单个文件同时下载的分片数。提高数值可能触发限流。',
        'commands.auto004': '建议使用 4 或 8；12 或 16 为高并发，需要二次确认。',
        'commands.auto005': '📦 **Telegram 文件级并发设置**',
        'commands.auto006': '当前同时下载文件数：**{value0}**',
        'commands.auto007': '当前队列：进行中 {value0}，等待中 {value1}',
        'commands.auto008': '同时下载的文件数。',
        'commands.auto009': '默认 2；1 降低并发，3 提高并发；4 需要二次确认。',
        ...
        'commands.auto034': '选择下一次或本聊天使用当前系统存储。',
        ...
        'commands.auto042': '选择下一次或本聊天使用当前系统存储。',
        ...
        'commands.auto065': '❌ OpenList 存储不支持手动删除文件。',
        'commands.auto066': '删除失败: {value0}',
        'commands.auto067': '请在 /tasks 中打开频道任务重试失败项',
        ...
        'commands.auto108': '旧取消按钮已失效，请用 /tasks 打开任务详情并确认。',
        'commands.auto109': '📮 没有找到当前聊天中的匹配任务：{value0}',
        'commands.auto110': '旧取消按钮已失效，请用 /tasks 打开任务详情并确认。',
        'commands.auto111': '任务 ID 前缀不唯一，请用 /tasks 刷新。',
        ...
        'commands.storageSwitchHint': '选择已配置的账户，切换系统默认存储。',
        'commands.storageSwitchOptions': '**可选存储：**',
        'commands.storageSwitchNote': '新增账户或配置 OAuth/密钥，请前往网页端。',
        ...
        'commands.targetHint': '选择下一次或本聊天使用当前系统存储。',
        'commands.targetCleared': '✅ 已清除当前聊天的自定义存储目标，后续任务使用系统默认。',
        ...
        'commands.targetScopeSession': '当前聊天',
        ...
        'commands.fileShareUnsupported': '当前存储不支持分享链接，可在网页端下载。',
        ...
        'commands.fileOpenListDeleteUnsupported': 'OpenList 存储不支持手动删除文件。',
        ...
        'commands.fileDeleteUnsupportedShort': '当前存储不支持手动删除文件',
        ...
        'commands.cleanupConfirmHint': '点击下方确认按钮删除。',
        ...
        'commands.taskLegacyCancel': '旧取消按钮已失效，请用 /tasks 打开任务详情并确认。',
        'commands.taskLegacyAmbiguous': '任务 ID 前缀不唯一，请用 /tasks 刷新。',
        ...
        'bot.wizard.confirmTitle': '确认任务范围：',
        ...
        'bot.wizard.confirmNote': '扫描进度会更新；可在任务中心取消。',
        ...
        'bot.wizard.subscriptionFolderLabel': '📁 订阅专属目录：{folder}\n{preview}',
        'bot.wizard.subscriptionDefaultLabel': '📁 订阅使用默认保存规则',
        ...
        'bot.callback.cursorUpdated': '同步位置已更新为当前最新消息',
        'bot.callback.followGlobal': '已改为跟随系统默认',
        'bot.callback.fixedTarget': '已固定为当前存储目标',
    ...
    en: {
        ...
        'bot.wizard.confirmNote': 'Scan progress will update. Cancel from the task center.',
        ...
        'bot.callback.cursorUpdated': 'Sync position set to the latest message',
        'bot.callback.followGlobal': 'Now using the system default',
        'bot.callback.fixedTarget': 'Fixed to the current storage target',
        ...
        'bot.callback.folderCleared': 'Subscription folder setting cleared',
        ...
        'bot.wizard.confirmSource': '📡 Source: {source}',
        'bot.wizard.confirmComments': '💬 Comments: {value}',
        'bot.wizard.folder.defaultValue': 'Default categorization rules',
        'bot.wizard.storage.current': 'Current storage',
        'bot.wizard.storage.currentAccount': 'Current account',
        'path.error.empty': 'Path cannot be empty',
        'path.error.illegalChars': 'Path contains invalid characters',
        'path.error.dotSegments': 'Path cannot contain . or ..',
        'path.error.invalid': 'Invalid path',
        'path.error.tooLong': 'Path is too long; use no more than 180 characters',
        ...
        'language.english': 'English',
        'language.russian': 'Русский',
        'language.hint': 'Choose the Bot interface language.',
        ...
        'auth.successBody': '✅ **PIN verified**\n\n📤 Send or forward a file to upload it (up to 2 GB; account downloads are not subject to this limit).\n📊 /storage for storage usage.',
        ...
        'auth.twoFactorActivated': '✅ **2FA enabled**',
        ...
        'bot.subscription.selectChannel': '{count} subscriptions. Select a channel to view details and manage it.',
        'bot.subscription.backToList': '← Back to channels',
        'help.body': "**📖 Command help**\n\nSend or forward files to upload.\n\n/start — Get started / authenticate\n/help — Show this help\n/language — Change language\n\n**📁 Files & destinations**\n\n/list — Recent files and IDs\n/find — Search and manage files\n/delete — Delete by file ID prefix\n/path_rules — Save location and folder rules\n/p — Folder for the next download\n/ps — Folder for this chat\n/pc — Clear custom folders\n/target — Storage target for next upload or chat\n\n**📥 Downloads & tasks**\n\n/tasks — View tasks and progress\n/task_pause — Pause chat tasks or a task\n/task_resume — Resume chat tasks or a task\n/task_cancel — Preview and cancel tasks\n/stop_tasks — Preview and stop chat tasks\n/tg_retry — Retry failed downloads\n\n**📡 Channels & subscriptions**\n\n/tg_download — Download channel files by date or tag\n/tg_sub — Set up channel auto-sync\n/tg_subs — List channel subscriptions\n/tg_unsub — Unsubscribe from a channel\n\n**⚙️ Storage & settings**\n\n/storage — Storage status / confirm local file deletion\n/storage_switch — Default storage for all new tasks\n/download_workers — Download workers per file\n/file_concurrency — Simultaneous file downloads\n/duplicate_mode — Duplicate file handling\n/cleanup_settings — Auto-clean unindexed temporary files\n/notifications — Notifications, timezone and quiet hours\n/status — System diagnostics\n\n**🔐 Account security**\n\n/setup_2fa — Set up two-factor authentication\n/logout — Sign out and revoke your Bot authentication",
        ...
        'channels.errors.fixedTargetProviderRequired': 'Choose a provider for the subscription’s fixed storage target',
        'channels.storageCooldown': '⏸️ Google Drive daily upload limit reached\n\nTask paused. It will resume automatically when the quota resets; no manual resume is needed.\n\nRetry time: {retryAt}\nTask: {jobId}',
        ...
        'upload.wait': 'Waiting for processing.',
        ...
        'upload.failureRetryNote': '🔄 Retried automatically once.',
        ...
        'upload.taskCancelled.controlsRemoved': 'Controls for this task are no longer active.',
        ...
        'taskCenter.button.resume': '▶️ Resume task',
        'taskCenter.button.undoPause': '▶️ Resume task',
        ...
        'status.defaultAdvice': 'For component errors, use the Request ID to check server logs.',
        ...
        'path.prompt.onceNote': 'Applies only to the next file accepted for download.',
        'path.prompt.sessionNote': 'Applies to future downloads in this chat until you send `/pc` or clear the setting.',
        ...
        'bot.home.category.main': 'Common commands',
        ...
        'bot.home.twoFactorHint': 'Send /setup_2fa to set up two-factor authentication.',
        ...
        'bot.home.followPrompt': '{description}\n\nFollow the prompt, or return to More for another action.',
        ...
        'bot.button.clearFolder': '🧹 Clear folder setting',
        ...
        'bot.notification.securityLogin': '🔔 **Login alert**\n\n👤 **Account**: Administrator\n⏰ **Time**: {time}\n🌐 **Location**: {location}\n💻 **Device**: {device}\n🔌 **IP address**: {ip}\n\n💡 If this was not you, check your server security settings immediately.',
        'bot.notification.passthrough': '{message}',
        ...
        'commands.auto003': 'Chunks downloaded at once per file. Higher values may trigger rate limits.',
        'commands.auto004': 'Use 4 or 8; high concurrency at 12 or 16 requires confirmation.',
        ...
        'commands.auto008': 'Files downloaded at once.',
        'commands.auto009': 'Default: 2. Use 1 for lower concurrency or 3 for higher concurrency; 4 requires confirmation.',
        ...
        'commands.auto049': 'Tap the confirmation button below to delete.',
        ...
        'commands.auto065': '❌ OpenList storage does not support manual file deletion.',
        'commands.auto066': 'Delete failed: {value0}',
        'commands.auto067': 'Open the channel task in /tasks to retry failed items.',
        ...
        'commands.auto129': 'High chunk concurrency may cause:',
        'commands.auto130': '- Telegram rate limits or anti-abuse restrictions',
        'commands.auto131': '- Interrupted downloads and more retries',
        'commands.auto132': '- Telegram account restrictions; severe cases may lead to a ban',
        'commands.auto133': 'Use 4 or 8 for routine downloads.',
        ...
        'commands.auto137': 'Confirmed {value0} chunks',
        'commands.auto138': '⚠️ **Download 4 files at the same time?**',
        'commands.auto139': 'High file concurrency may cause:',
        ...
        'commands.auto143': 'Use 2 or 3 for routine downloads.',
        'commands.auto144': '{value0}\n\n✅ Switched to downloading {value1} files at the same time.',
        'commands.auto145': 'Set to {value0}',
        'commands.auto146': '{value0}\n\n⚠️ Confirmed and switched to downloading {value1} files at the same time. If rate limits, disconnects, or upload failures occur, immediately return to 2 or 3.',
        ...
        'commands.storageSwitchHint': 'Select a configured account to change the system default storage.',
        'commands.storageSwitchOptions': '**Available storage:**',
        'commands.storageSwitchNote': 'Add accounts or configure OAuth/credentials in the web app.',
        ...
        'commands.targetHint': 'Use the current system storage for the next download or this chat.',
        ...
        'commands.fileShareUnsupported': 'This storage does not support share links. Download the file in the web app.',
        ...
        'commands.fileOpenListDeleteUnsupported': 'OpenList storage does not support manual file deletion.',
        ...
        'commands.fileDeleteUnsupportedShort': 'This storage does not support manual file deletion',
        ...
        'commands.cleanupConfirmHint': 'Tap the confirmation button below to delete.',
        ...
        'commands.retryChannelDone': '🔄 Requeued {count} failed channel-task items\nTask: {task}',
